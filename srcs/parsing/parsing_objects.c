...
/*   Updated: 2020/05/23 15:02:52 by gihwan-kim       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parsing_plane(char **split, t_rt *rt_info)
{
	...
	if (check_three_arg(split[2], check_str_isdouble))
		store_vec(split[2], &(plane->orient_vec));
	else
...
int	parsing_square(char **split, t_rt *rt_info)
{
	...
	// normalize vec
	if (check_three_arg(split[2], check_str_isdouble))
		store_vec(split[2], &(square->orient_vec));
	else
...
int	parsing_cylinder(char **split, t_rt *rt_info)
{
	...
	// normalize vec
	if (check_three_arg(split[2], check_str_isdouble))
		store_vec(split[2], &(cylinder->orient_vec));
	else
...
int	parsing_triangle(char **split, t_rt *rt_info)
{
	...
	// normalize vec
	if (check_three_arg(split[2], check_str_isdouble))
		store_vec(split[2], &(triangle->orient_vec));
	else
